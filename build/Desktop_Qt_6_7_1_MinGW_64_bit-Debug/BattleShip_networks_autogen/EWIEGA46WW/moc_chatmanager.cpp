...
constexpr auto qt_meta_stringdata_CLASSchatmanagerENDCLASS = QtMocHelpers::stringData(
    "chatmanager",
    "displayMessage",
    "",
    "msg"
...
void chatmanager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (chatmanager::*)(const QString & );
            if (_t _q_method = &chatmanager::displayMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void chatmanager::displayMessage(const QString & _t1)
{
